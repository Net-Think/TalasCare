                                ...
                                <div class="row mt-2 mb-5">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="text" class="form-profil" value="<?= $user['username']?>" disabled>
                                        </div>
                                        <div class="form-group mt-3">
                                            <label>Nomor Telepon</label>
                                            <input type="number" class="form-profil" value="<?= $user['no_telepon']?>" disabled>
                                        </div>
                                        <div class="form-group mt-3">
                                            <label>Email</label>
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="form-group mt-3">
                                            <label>Alamat</label>
                                            <textarea type="text" class="form-profil" rows="7" disabled><?= $user['alamat']?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
